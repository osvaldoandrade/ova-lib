...
- ASan local: needs LD_PRELOAD of libasan because shared lib path.
...
- DONE 2026-04-29: bloom_filter fused dual FNV-1a (PR pending; this run).
...
- TODO: skip_list — review RNG cost of level selection.
...
- 2026-04-29 20:52 UTC: bloom_filter dual-hash PR (16B 1.13–1.27×, 128B 1.59–1.65×).
